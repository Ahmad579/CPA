...
class CPAForgotPAsswordVC: UIViewController , NVActivityIndicatorViewable {
            ...
            WebServiceManager.post(params:loginParam as Dictionary<String, AnyObject> , serviceName: FORGOTPASSWORD_API, isLoaderShow: true, serviceType: "Forgot Password", modelType: UserResponse.self, success: { (response) in
                ...
                if responseObj.success == true {
                    ...
                    self.showAlertViewWithTitle(title: "CPA", message: responseObj.message!, dismissCompletion: {
                        let vc = self.storyboard?.instantiateViewController(withIdentifier: "CPAVerifyCodeVC") as? CPAVerifyCodeVC
