...
//        let rightmenuVC = mainStoryboard.instantiateViewController(withIdentifier: rightMenuIdentifier)
...
//        let menuController = PKRevealController(frontViewController: homeNavigation, leftViewController: menuVC, rightViewController: rightmenuVC)
