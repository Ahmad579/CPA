...
struct ProductionServerURL {
  static  let BASE_URL  =  "http://pfd.techeasesol.com/api/v1/"
...
let BASE_URL  =  "http://divergense.com/cpa/"
...
let GETALLFOLDER = BASE_URL + "app/allFolders"
let ALLFILEINFOLDER = BASE_URL + "app/allFiles"
let UPLOADFILE = BASE_URL + "app/uploadFile"
let BLOGLIST = BASE_URL + "app/getBlogs"
let FILEDETAIL = BASE_URL + "app/fileDetail"
let ALLUSERLIST = BASE_URL + "app/getAllUsers"
let CREATEMESSAGE = BASE_URL + "app/createMessage"
let UPDATEPROFILE = BASE_URL + "app/UpdateProfile"
let UPDATEPASSWORD = BASE_URL + "app/passwordUpdate"
let CREATEFOLDER = BASE_URL + "app/createFolder"
let RESETPASSWORD = BASE_URL + "signup/Resetpassword"
let EMAILPREFERENCE = BASE_URL + "app/emailPrefernces"
...
let FORGOTPASSWORD_API = BASE_URL + "signup/forgot"
